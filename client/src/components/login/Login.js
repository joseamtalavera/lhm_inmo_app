        ...
        <Grid item >
          ...
          <Grid container justifyContent="space-between" alignItems="center">
            <Typography variant='body2'>
              <Link href="#" onClick={handleRecoveryClick} underline='none'>Has olvidado tu contraseña?</Link>
            </Typography>
          </Grid>
          ...
          <Button
            ...
            variant="contained" 
            fullWidth
            sx={{ mt: 0, mb: 2, backgroundColor: '#1E90FF', '&:hover': { backgroundColor: 'blue' } }}
          >
            Log In
          </Button>
          ...
          <Link href="#" underline='none'> Terminos & Condiciones</Link> y <Link href="#" underline='none'>Politica de Privacidad</Link>.
          </Typography>
